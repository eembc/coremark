...
/* Topic : Description
        This file maps coremark defines to zephyr's according Kconfig options
*/
...
*/
#ifndef MULTITHREAD
/* CONFIG_POSIX_THREADS for supporting pthread is always set in prj.conf */
#define MULTITHREAD 1
#define USE_PTHREAD MULTITHREAD
#define USE_FORK    0
#define USE_SOCKET  0
#endif
